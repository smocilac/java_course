...
public class Mkdir implements ShellCommand {
	 ...
	 */
	public Mkdir(String name, String description) {
		if(name == null){
	...
	public ShellStatus executeCommand(Environment env, String arguments) {
		...
		try {
	        ...
	        if (f.mkdir()){
	        	env.writeln("Directory created succesfuly !");
	        } else {
	        	env.writeln("Directory could not be created !");
	        }
		} catch (Exception e){
